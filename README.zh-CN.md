...
[产品网页](https://fanfanfanfanfan626.github.io/challenge-and-refine-ideas/) · [English](README.md) · [AI 安装说明](AI_INSTALL.md) · [使用示例](EXAMPLES.md) · [兼容性证据](COMPATIBILITY.md) · [下载 v2.0.2 ZIP](dist/challenge-and-refine-ideas-v2.0.2.zip) · [更新记录](CHANGELOG.md)
...
仓库还提供经过审查的独立分发包：[`dist/challenge-and-refine-ideas-v2.0.2.zip`](dist/challenge-and-refine-ideas-v2.0.2.zip)。包内包含 MIT 许可证。
