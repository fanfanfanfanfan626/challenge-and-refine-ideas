...
| --- | --- | --- |
| Repository and standalone ZIP | Verified for 2.0.1 | The validator checks the exact eight-file package, nested MIT license, references, invariants, local-path leakage, ZIP bytes, checksum, and public version markers. |
